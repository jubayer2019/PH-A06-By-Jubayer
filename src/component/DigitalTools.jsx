...
const DigitalTools = ({ digitalPromise, onBuy, cartItems }) => {
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {digitalProduct.map((product, index) => {
            ...
            return (
              <div key={index} className="card relative bg-white shadow-sm hover:shadow-md transition-all border border-slate-100 rounded-xl p-6 flex flex-col h-full">
                {product.status && (
                ...
                <div className="mb-4">
                  <img src={product.image} className="w-12 h-12 rounded-full border border-slate-200 object-contain p-2 bg-slate-50" alt="" />
                </div>
                <div className="grow">
